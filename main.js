...
function getElementDescendant(parent, selector) {
	const element = parent.querySelector(selector);

	if ( isNull(element) ) {
		console.warn(`Element with selector ${selector} is null or undefined.`);
		return null;
	}
...
/** 
 * Creates a wave animation on an exisitng SVG path.
 * 
 ...
 * @return {void}
*/
function setWave(parent_container_selector, wave_speed = 0.5, wave_points = 6, wave_height = 75, wave_delta = 20) {
	const parentContainer = document.querySelectorAll(parent_container_selector);
